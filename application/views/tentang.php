    ...
    <div class="banner_inner d-flex align-items-center">
        ...
        <div class="container">
            <div class="banner_content text-center">
                <h2 data-aos="fade-up" data-aos-duration="1600">Tentang Learnify Education</h2>
...
<section class="about_area p_60">
    <div class="container">
        <div class="main_title">
            <h2 data-aos="fade-up" data-aos-duration="1600" style="font-size: 33px !important;">Tentang Learnify Education - Web Edukasi</h2>
            <p data-aos="fade-up" data-aos-duration="1800"> Website
        ...
        <div class="row about_inner">
            ...
            <div class="col-lg-6">
                <div class="video_area" id="video">
                    <img class="img-fluid" src="<?= base_url('assets/') ?>img/home-banner.jpg" alt="" />
                    <a class="popup-youtube" href="https://www.youtube.com/watch?v=sNvExjAL9zo">
